...
const _pbUrl = typeof window !== "undefined" ? (!window.location.origin.startsWith("https") ? 'http://127.0.0.1:8090' : 'https://pocketbase.danielmorgan.xyz') : process.env.POCKETBASE_URL;
if (!_pbUrl) {
